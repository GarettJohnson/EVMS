...
% Moddemeijer, R. On Estimation of Entropy and Mutual Information of Continuous Distributions, Signal Processing, 1989, vol. 16, nr. 3, pp. 233-246

% modified by GDJ because this idiot had shitty checks using nargin...
% fucker also tried to redefine a matlab function 'histogram', so that 
% was changed to 'histogramModified.m'
...
if isempty(descriptor)
    [h,descriptor]=histogramModified(x);
else
    [h,descriptor]=histogramModified(x,descriptor);
end;
